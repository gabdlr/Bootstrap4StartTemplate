  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        ...
        <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce quis tortor ac eros congue
      ...
      <div class="col-md-4 text-center">
        ...
        <p>Siempre viva 742</p>
        <p>Springfield, OR 19050</p>
        <nav class="sociales text-center pt-4">
          <ul>
