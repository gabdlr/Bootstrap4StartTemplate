        ...
        <div class="card">
          <a href="">
            ...
            <div class="card-body">
              ...
              <p class="card-text text-uppercase text-justify">Vivamus sagittis volutpat sapien, in aliquet nibh congue
                vel.</p>
              <p class="lead text-center precio mb-0">$25</p>
            </div>
          </a>
        </div>
        <!--.card-->
        ...
        <div class="card">
          <a href="">
            ...
            <div class="card-body">
              ...
              <p class="card-text text-uppercase text-justify">Vivamus sagittis volutpat sapien, in aliquet nibh congue
                vel.</p>
              <p class="lead text-center precio mb-0">$35</p>
            </div>
          </a>
        </div>
        <!--.card-->
        ...
        <div class="card">
          <a href="">
            ...
            <div class="card-body">
              ...
              <p class="card-text text-uppercase text-justify">Vivamus sagittis volutpat sapien, in aliquet nibh congue
                vel.</p>
              <p class="lead text-center precio mb-0">$50</p>
            </div>
          </a>
        </div>
        <!--.card-->
        ...
        <div class="card">
          <a href="">
            ...
            <div class="card-body">
              ...
              <p class="card-text text-uppercase text-justify">Vivamus sagittis volutpat sapien, in aliquet nibh congue
                vel.</p>
              <p class="lead text-center precio mb-0">$45</p>
            </div>
          </a>
        </div>
        <!--.card-->
  ...
  <div class="container-fluid citas py-5">
    <div class="row justify-content-center">
      <div class="col-lg-6 col-md-8 text-center">
        ...
        <p class="mt-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce quis tortor ac eros congue
          blandit et sed felis. Sed aliquam viverra sem, id luctus nunc luctus quis.</p>
        <a href="" class="btn btn-primary mt-3 btn-lg text-uppercase">Leer mas</a>
      </div>
    </div>
  </div>
  <!--.citas-->
